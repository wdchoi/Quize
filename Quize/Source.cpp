...
int main(void)
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//draw circle and circle
		drawcircle(200, 375, 20, 1.0f, 0.0f, 0.0f);
		drawCircle(200, 375, 50, xpos, 480 - ypos);
		...
		//draw X and circle
		drawLine(425, 350, 475, 400, 1.0f, 0.0f, 0.0f);
		drawLine(425, 400, 475, 350, 1.0f, 0.0f, 0.0f);
		drawCircle(450, 375, 50, xpos, 480 - ypos);
		...
		//draw กๆ and circle
		drawLine(50, 150, 100, 150, 1.0f, 0.0f, 0.0f);
		drawLine(100, 150, 85, 165, 1.0f, 0.0f, 0.0f);
		drawLine(100, 150, 85, 135, 1.0f, 0.0f, 0.0f);
		drawCircle(75, 150, 50, xpos, 480 - ypos);
		...
		//draw 1 and circle
		drawThickerLine(325, 125, 325, 175);
		drawCircle(325, 150, 50, xpos, 480 - ypos);
